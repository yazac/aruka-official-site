<template>
  <CommonContentsInner>
    ...
    <CommonTextNormal>
      当サイトでは、お問い合わせの際に、名前、メールアドレス等の個人情報を入力いただく可能性があります。
      これらの個人情報は、以下の目的以外では利用しません。
      <ul>
        <li>お問い合わせに対する回答および必要な情報のご連絡</li>
    ...
    <CommonTextNormal>
      当サイトでは、取得した個人情報を、法令に基づく場合を除き、本人の同意なく第三者に提供することはありません。
    </CommonTextNormal>
    ...
    <CommonTextNormal>
      当サイトでは、サイトの利用状況を把握するために Google Analytics を利用しています。
      Google Analyticsはトラフィックデータの収集のためにCookieを使用していますが、これらのデータは匿名で収集されており、個人を特定するものではありません。

      Cookieを無効にすることで、データの収集を拒否することが可能です。お使いのブラウザの設定をご確認ください。
      Google Analyticsの利用に関する詳細は、Googleのプライバシーポリシーをご確認ください。
    </CommonTextNormal>
    ...
    <CommonTextNormal>
      当サイトは、法令の変更や運営方針の見直し等により、本プライバシーポリシーを予告なく変更することがあります。
...
useHead({
  ...
  meta: [
    { name: 'description', content: meta.pages.privacyPolicy.description.jp },
    { property: 'og:title', content: meta.pages.privacyPolicy.title },
    { property: 'og:description', content: meta.pages.privacyPolicy.description.jp },
    { property: 'og:url', content: `${meta.domain}${path}` },
    { name: 'twitter:title', content: meta.pages.privacyPolicy.title },
    { name: 'twitter:description', content: meta.pages.privacyPolicy.description.jp },
  ]
})
</script>
