...
useHead({
  ...
  meta: [
    { name: 'description', content: meta.pages.home.description.jp },
    { property: 'og:title', content: meta.pages.home.title },
    { property: 'og:description', content: meta.pages.home.description.jp },
    { property: 'og:url', content: `${meta.domain}${path}` },
    { name: 'twitter:title', content: meta.pages.home.title },
    { name: 'twitter:description', content: meta.pages.home.description.jp },
  ]
})
